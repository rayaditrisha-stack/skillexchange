...
const seedDatabase = async () => {
  try {
    ...
    await SkillSwapSession.deleteMany({});
    ...
    await SkillSwapSession.create([
      {
        mentorId: alex._id,
        learnerId: sophia._id,
        skillName: 'React.js',
        sessionTime: new Date(Date.now() + 18 * 60 * 60 * 1000), // 18 hrs from now
      ...
      },
      {
        ...
        sessionTime: new Date(Date.now() + 42 * 60 * 60 * 1000), // 42 hrs from now
      ...
      },
      {
        ...
        sessionTime: new Date(Date.now() - 24 * 60 * 60 * 1000), // yesterday
