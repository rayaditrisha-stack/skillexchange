    ...
    <div className="space-y-6">
      {sessions.map((sess) => {
        ...
        return (
          <div
            key={sess._id}
            className="glass-card p-6 rounded-2xl border border-slate-800 space-y-6 shadow-xl relative overflow-hidden"
          >
            ...
            <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 border-b border-slate-800/80 pb-4">
              ...
              <div className="flex flex-wrap items-center gap-2">
                ...
                <a
                  ...
                  className="px-3 py-1.5 rounded-xl bg-violet-600/20 border border-violet-500/40 text-violet-300 hover:bg-violet-600/30 text-xs font-semibold flex items-center gap-1.5 transition-colors"
                >
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 pt-1">
              ...
              <div className="space-y-2">
                <p className="text-xs font-mono font-bold text-slate-400 uppercase tracking-wider flex items-center gap-1.5">
                      ...
                      {[1, 2, 3, 4, 5].map((star) => (
                        <button
                          ...
                          className={`p-0.5 transition-colors ${
                            star <= ratingScore ? 'text-amber-400' : 'text-slate-700'
                          }`}
                        >
