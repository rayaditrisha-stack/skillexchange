  ...
  return (
    <div className="relative min-h-screen transition-colors duration-300 dark:bg-[#040507] bg-[#F7F7F8] text-slate-900 dark:text-slate-100 font-sans selection:bg-amber-500/20 selection:text-amber-500 px-4 sm:px-6 lg:px-8 py-12">
      ...
      <div className="relative z-10 max-w-xl mx-auto space-y-8">
        ...
        <div className="dark:bg-[#08090C]/90 bg-white/90 border dark:border-white/[0.07] border-black/[0.08] shadow-2xl rounded-3xl p-6 sm:p-8 backdrop-blur-2xl space-y-6">
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              <div>
                ...
                <input
                  ...
                  className="w-full px-4 py-2.5 rounded-2xl text-xs dark:bg-black/40 bg-slate-50 border dark:border-white/10 border-black/10 text-slate-900 dark:text-white placeholder-slate-400 focus:outline-none focus:border-amber-500 font-sans"
                />
              </div>
              ...
              <button
                type="submit"
                className="w-full py-3 rounded-full dark:bg-white dark:text-slate-950 bg-slate-900 text-white font-mono text-xs uppercase tracking-wider font-semibold hover:opacity-90 transition-all flex items-center justify-center gap-2 shadow-xl pt-3"
              >
