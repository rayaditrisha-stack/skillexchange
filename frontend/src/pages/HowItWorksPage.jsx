    ...
    <div className="relative min-h-screen transition-colors duration-300 dark:bg-[#040507] bg-[#F7F7F8] text-slate-900 dark:text-slate-100 font-sans selection:bg-amber-500/20 selection:text-amber-500 px-4 sm:px-6 lg:px-8 py-12">
      ...
      <div className="relative z-10 max-w-5xl mx-auto space-y-16">
        ...
        <div className="space-y-8">
          ...
          {/* Chapter 01 */}
          <div className="dark:bg-[#08090C]/80 bg-white/90 border dark:border-white/[0.07] border-black/[0.08] shadow-xl rounded-3xl p-8 backdrop-blur-xl relative overflow-hidden group">
        ...
        <div className="space-y-6 pt-8">
          <div className="text-center space-y-2">
            <h2 className="text-[10px] font-mono uppercase tracking-[0.2em] text-amber-600 dark:text-amber-400">FREQUENTLY ASKED QUESTIONS</h2>
          ...
          <div className="space-y-3">
            {FAQS.map((faq, idx) => {
              ...
              return (
                <div
                  key={idx}
                  className="dark:bg-[#08090C]/80 bg-white/90 border dark:border-white/[0.07] border-black/[0.08] shadow-md rounded-2xl overflow-hidden transition-all"
                >
                  <button
